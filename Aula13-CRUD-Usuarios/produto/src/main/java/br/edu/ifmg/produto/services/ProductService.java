...
public class ProductService {
    ...
    public ProductDTO findById(Long id){
        ...
        return new ProductDTO(product)
                ...
                .add(linkTo(methodOn(ProductResource.class).findAll(null)).withSelfRel())
                .add(linkTo(methodOn(ProductResource.class).update(product.getId(), null)).withSelfRel())
    ...
    public ProductDTO insert(ProductDTO dto){
        ...
        return new ProductDTO(entity)
                ...
                .add(linkTo(methodOn(ProductResource.class).update(entity.getId(), null)).withRel("Update a product"))
